...
def get_parser():
    parser = argparse.ArgumentParser(description='Non Linear Classifier on RotNet')
...
if __name__ == '__main__':
    ...
    args.results_dir = os.path.join(args.results_dir, 'rotnet_nonlinear_classifier', 'nins_'+str(args.nins)+'_layer_'+str(args.layer)+args.suffix)
