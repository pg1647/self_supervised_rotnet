...
def get_parser():
    parser = argparse.ArgumentParser(description='Randomly Initialized RotNet with Non Linear Classifier')
...
if __name__ == '__main__':
    ...
    args.results_dir = os.path.join(args.results_dir, 'randominit_nonlinear_classifier', 'nins_'+str(args.nins)+'_layer_'+str(args.layer)+args.suffix)
