...
#SBATCH --job-name=rand_nonlinear
#SBATCH --output=results/slurm_files/slurm_randominit_nonlinear_%j.out
...
python randominit_nonlinear.py --nins=5 --batch_size=128 --epochs=200 --layer=$1