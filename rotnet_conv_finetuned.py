...
def get_parser():
    parser = argparse.ArgumentParser(description='Conv Classifier on RotNet with RotNet also Finetuned')
...
if __name__ == '__main__':
    ...
    args.results_dir = os.path.join(args.results_dir, 'rotnet_conv_classifier_finetuned', 'nins_'+str(args.nins)+'_layer_'+str(args.layer)+args.suffix)
