...
#SBATCH --job-name=natnet
#SBATCH --output=results/slurm_files/slurm_natnet_%j.out


# when the job ends, send me an email at this email address.
#SBATCH --mail-type=END
#SBATCH --mail-user=hi348@nyu.edu

module purge
module load cuda/10.1.105
module load cudnn/10.1v7.6.5.32
module load anaconda3/5.3.1
source activate pytorchenv2
...
python natnet.py --nins=$1 --batch_size=128 --epochs=$2

# run this scripts like:
# sbatch run_natnet.sh 3
