...
#SBATCH --job-name=rotnet
#SBATCH --output=results/slurm_files/slurm_rotnet_%j.out
...
python rotnet.py --nins=$1 --batch_size=64 --epochs=$2 --suffix=$2

# run this scripts like:
# sbatch run_rotnet.sh 3