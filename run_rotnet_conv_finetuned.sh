...
#SBATCH --job-name=convfinerotnet
#SBATCH --output=results/slurm_files/slurm_rotnet_conv_finetuned_%j.out
...
python rotnet_conv_finetuned.py --nins=$1 --batch_size=128 --epochs=100 --layer=$2 --rot_model_type='_best_acc'
