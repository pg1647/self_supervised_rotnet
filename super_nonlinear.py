...
def get_parser():
    parser = argparse.ArgumentParser(description='Supervised Non Linear Classifier')
...
if __name__ == '__main__':
    ...
    args.results_dir = os.path.join(args.results_dir, 'super_nonlinear_classifier', 'nins_'+str(args.nins)+'_layer_'+str(args.layer)+args.suffix)
